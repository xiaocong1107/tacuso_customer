...
function getQuestionList(){
    $.post("/question/getUserCenterQuestions",{referer_page:"tacuso_figure_info"},renderQuestionList,'json');
}
...
function restoreQuestion(){
    ...
    $.post("/question/getUserCenterQuestionsRecord",{referer_page:"tacuso_figure_info"},function(data){
...
//            history.pushState({"page":"/usercenter/size"},"",window.location.href);
            window.history.go(-1);
            setTimeout(function() {
                $toast.hide();
//                window.location.href = '/usercenter/editUserInfo';
//                window.location.replace("/usercenter/editUserInfo")
            }, 500);
        });
