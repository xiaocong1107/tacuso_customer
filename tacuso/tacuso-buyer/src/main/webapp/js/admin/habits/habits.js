...
function getQuestionList(){
    $.post("/questionadmin/getUserCenterQuestions",{referer_page:"tacuso_consume_info",uid:uid},renderQuestionList,'json');
}
...
function restoreQuestion(){
    ...
    $.post("/questionadmin/getUserCenterQuestionsRecord",{referer_page:"tacuso_consume_info",uid:uid},function(data){
...
function bindQuestionEvent() {
    ...
    $saveBtn.on('click', function () {
        ...
        $.post("/page/save",{"answerList":JSON.stringify(answer_select_list)},function(data){
            ...
            history.pushState({"page":"/usercenteradmin/habits"},"",window.location.href);
