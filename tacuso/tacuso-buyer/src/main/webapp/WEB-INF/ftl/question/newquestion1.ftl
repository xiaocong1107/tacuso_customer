...
<body id="app">
  <section class="question-page">
    <section class="page-header">
      <div class="progress">已完成<em>1</em>/5</div>
    </section>
  ...
  <section class="mask-box">
    ...
    <h3 class="mask-title">新用户，你好!</h3>
    <p class="mask-desc">为了提供更好的服务体验和搭配效果，我们需要对你有个初步了解～</p>
    <div class="line"></div>
    <div class="start">
      <div class="start-title">开始吧</div>
  ...
  <script src="/js/newquestion/new-question-1.js"></script>
