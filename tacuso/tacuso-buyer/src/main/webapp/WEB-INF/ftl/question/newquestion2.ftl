...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/css/new-question-2.css">
    </head>
<body>
  ...
  <script id="questionPage"  type="text/html">
	     <section class="page-header">
	      <div class="progress">已完成<em>2</em>/5</div>
	    </section>
    
        <section class="page-desc">
	      	匹配码数和版型，能确保推荐的衣服舒适合身
	    </section>
	    <div class="line"></div>
...
-->
  ...
  <script id="ChoiceQuestion" type="text/html">
      ...
      <section class="question-box square {{question.question_class}}" question-id="{{question.question_id}}"  question-type="{{question.question_type}}">
  ...
  <script src="/js/newquestion/new-question-2.js"></script>
</body>
</html>