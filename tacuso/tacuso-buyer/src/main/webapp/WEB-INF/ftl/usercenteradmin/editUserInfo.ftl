...
<section class="editUserInfo-page">
    ...
    <section class="nav-list">
        <a class="nav-item" href="/usercenteradmin/style?uid=${userinfo.uid}">
            <div class="icon icon-shirt"></div>
            <div class="nav-name">着装偏好</div>
            <div class="icon-arrow"></div>
        </a>
        <a class="nav-item" href="/usercenteradmin/size?uid=${userinfo.uid}">
            <div class="icon icon-height"></div>
            <div class="nav-name">身材尺码</div>
            <div class="icon-arrow"></div>
        </a>
        <a class="nav-item" href="/usercenteradmin/habits?uid=${userinfo.uid}">
    ...
    <a href="/usercenteradmin/index" class="go-center">返回个人中心</a>
