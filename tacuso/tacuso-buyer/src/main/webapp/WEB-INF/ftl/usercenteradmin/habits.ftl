...
<body>
<section class="page habit-page">
    <section class="page-header">
        <a class="nav nav-1 active" data-index="1">消费预算<br><em>購入された予算</em></a>/
        <a class="nav nav-2" data-index="2">消费习惯<br><em>購入された予算</em></a>
    </section>
...
<script id="multiChoiceQuestion" type="text/html">
    ...
    <section class="habit-box multiChoiceQuestion {{question.question_class}}" id="{{question.attr_id_name}}" question-id="{{question.question_id}}"  question-type="{{question.question_type}}">
        <h3 class="title"> {{question.question_title}} </h3>
...
<script id="ChoiceQuestion" type="text/html">
    ...
    <section class="habit-box ChoiceQuestion square {{question.question_class}}" id="{{question.attr_id_name}}" question-id="{{question.question_id}}"  question-type="{{question.question_type}}">
...
<script id="selectChoiceQuestion" type="text/html">
    <section class="style-box selectChoiceQuestion" id="{{question.attr_id_name}}"  question-id="{{question.question_id}}" question-type="{{question.question_type}}">
        <h3 class="title"> {{question.question_title}} </h3>
...
<script src="/js/admin/habits/habits.js"></script>
</body>
</html>