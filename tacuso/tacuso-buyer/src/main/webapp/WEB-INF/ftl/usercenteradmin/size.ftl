...
<body>
<section class="page size-page">
    <section class="size-header">
        <a class="nav nav-1 active" data-index='1'>基础数据<br><em>基本データ</em></a>/
        <a class="nav nav-2" data-index='2'>详细数据<br><em>基本データ</em></a>/
        <a class="nav nav-3" data-index='3'>身型选择<br><em>基本データ</em></a>
    </section>
...
<script src="/js/admin/size/size.js"></script>
</body>
</html>