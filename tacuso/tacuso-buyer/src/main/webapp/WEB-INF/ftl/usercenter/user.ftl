...
<section class="register-mask fhide">
    <div class="mask-box">
        <div class="mask-box__header">
            <!-- <div class="close-btn"></div> -->
        </div>
...
<section class="register-box">
    ...
    <p class="mask-desc">我们已经收到你的资料，将尽快为你搭配好衣服送到你家，敬请留意首次盒子推送</p>
    <div class="line"></div>
    <div class="about-box">
      <div class="about-time">
        <p class="about">预计首次盒子送达时间</p>
        <div class="time">${time}</div>
      </div>
    </div>
    <div class="bottom-line"></div>
    <div class="i-see">知道了</div>
  </section>

<div class="mask-bg"></div>

<script>
	var first_login = ${isFirst};
</script>
