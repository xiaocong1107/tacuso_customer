...
<body>
    ...
    <section class="confirm-container"> 
      ...
      <section class="picker-box">
        ...
        <div class="picker-list">
          <div class="pick-item active">T恤</div>
          <div class="pick-item">Polo衫</div>
          <div class="pick-item">长袖衬衫</div>
          <div class="pick-item">短袖衬衫</div>
          <div class="pick-item">卫衣</div>
          <div class="pick-item">夹克</div>
        </div>
      </section>
      <section class="picker-box">
        <div class="sub-title"><span>长裤</span></div>
        <div class="picker-list">
          <div class="pick-item">休闲裤</div>
          <div class="pick-item">束脚裤</div>
          <div class="pick-item">九分裤</div>
          <div class="pick-item">牛仔裤</div>
          <div class="pick-item">短裤</div>
          <div class="pick-item">西裤</div>
        </div>
      </section>
      <section class="other-info" id="box1">
        <section class="bottom-info">
          <h3 class="title">有其他具体的需求吗</h3> 
          <textarea placeholder="留言更多需求，我们将为你推荐合适的衣服"></textarea>
        </section>
  ...
  <section class="address-list__box">
    ...
    <section class="address-list">
      ...
      <!-- 循环用户收件地址 -->
      <section class="address-item selected" data-index="0">
      ...
      <section class="address-item" data-index="1">
        <div class="picker-icon"></div>
        <div class="address-info">
          <div class="user-info">
  ...
  <script>
    var addressList = [{
      ...
      tel: '13800138000',
      city: '广东/广州/天河',
      address: '北京东路的日子99号转左',
    }];
  </script>
  <script src="../js/zepto.js"></script>
  <script src="../js/picker.min.js"></script>
  <script src="../js/city.js"></script>
  <script src="../js/buy-box.js"></script>
</body>
</html>