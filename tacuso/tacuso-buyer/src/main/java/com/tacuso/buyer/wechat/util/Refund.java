...
public class Refund {
	...
	public static PageData refund(PageData pd, HttpServletRequest request, HttpServletResponse response) throws Exception {
		String appid = "wx4c2237a9ffb256b9";
		String appsecret = "bc6992ea3f9e5195a331a45096e87782";
		String partner = "1496570232";
		String partnerkey = "rQN0kZwa45Tf0pg0R0Zfw5Xm5WZaedE2";
		String path = "/usr/local/tomcat_mallapp/webapps/mallapp/cert/apiclient_cert.p12";

		String order_id = pd.getString("order_id");
		String refund_id = DateUtil.sDateFormat();//pd.getString("refund_id");
