...
public class QuestionAdminController extends BaseController {
    ...
    @ResponseBody
    public JsonResult getQuestionsRecord(HttpServletRequest request , HttpServletResponse response , Model model , @RequestParam Integer page_id){
...
//        Integer uid = (Integer) session.getAttribute("uid");
        ...
        List<String> answerList = questionService.getRecordFromRedis(Integer.parseInt(uid),questionIdList);
    ...
    @ResponseBody
    public JsonResult getUserCenterQuestionsRecord(HttpServletRequest request ,HttpServletResponse response ,Model model ,@RequestParam String referer_page){
...
//        Integer uid = (Integer) session.getAttribute("uid");
        String  uid =   request.getParameter("uid");
        System.out.println("getUserCenterQuestionsRecord---uid===="+uid);
