...
public class FigureInfo extends SuperEntity {
    ...
    private String sleeve_size;
    private String bust;
    private String waistline;
    private String hips;
    private String thigh_size;
    private String leg_siez;
    ...
    public String getSleeve_size() {
        return sleeve_size;
    }

    public void setSleeve_size(String sleeve_size) {
        this.sleeve_size = sleeve_size;
    }
    ...
    public String getLeg_siez() {
        return leg_siez;
    }

    public void setLeg_siez(String leg_siez) {
        this.leg_siez = leg_siez;
    }
